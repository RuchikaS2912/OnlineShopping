  ...
  return (
    <>
      <Toast show={toast1} onClose={close1} className="ms-4 mb-5">
        <Toast.Header>
          <strong className="me-auto">Chat with John hoe</strong>
        </Toast.Header>
        <Toast.Body>
            ...
            {Array.from({ length: 30 }).map((_, idx) => (
              <Fragment key={idx}>
                <p className="bg-primary p-3 ms-4 text-light rounded-pill">
                  <b>User wrote:</b>Woohoo, you're reading this text in a Toast!
                </p>
                <p>
                  <b>Admin wrote:</b>Woohoo, you're reading this text in a
                  Toast!
                </p>
              </Fragment>
            ))}
